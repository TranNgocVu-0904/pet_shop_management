...
public class ProductPanel extends JPanel {
    ...
    public ProductPanel() {
        ...
        productTable.getColumn("Update").setCellRenderer(new TableButtonRenderer("✏️"));
        productTable.getColumn("Delete").setCellRenderer(new TableButtonRenderer("🗑️"));

        productTable.getColumn("Update").setCellEditor(new TableButtonEditor<>(
                productTable,
                "update",
        ...
        productTable.getColumn("Delete").setCellEditor(new TableButtonEditor<>(
                productTable,
                "delete",
                this::mapRowToProduct,
                null,
