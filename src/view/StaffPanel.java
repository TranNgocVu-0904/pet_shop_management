...
public class StaffPanel extends JPanel {
    ...
    public StaffPanel() {
        ...
        staffTable.getColumn("Update").setCellRenderer(new TableButtonRenderer("✏️"));
        staffTable.getColumn("Delete").setCellRenderer(new TableButtonRenderer("🗑️"));

        staffTable.getColumn("Update").setCellEditor(new TableButtonEditor<>(
                staffTable,
                "update",
                this::mapRowToStaff,
                staff -> {
        ...
        staffTable.getColumn("Delete").setCellEditor(new TableButtonEditor<>(
                staffTable,
                "delete",
                this::mapRowToStaff,
                null,
